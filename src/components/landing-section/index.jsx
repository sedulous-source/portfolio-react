        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            <div className="landing-section__content">
              ...
              <a className="button button--secondary button--lg" href="#body"><span className='pe-1 pe-lg-2'>Know more</span><i className="bi bi-chevron-double-down"></i></a>
            </div>
          </div>
        </div>
      </div>
